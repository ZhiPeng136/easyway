                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                ListRutaSingleton.getInstance().onReset();
                                for (int k = 0; k < routesArray.length(); k++) {
                                    ...
                                    for (int i = 0; i < legs.length(); i++) {
                                        ...
                                        ListRutaSingleton.getInstance().addElement(new Ruta(origen,destino,durationText,distancia,tInicio,tFin,duracionSegundo));
                                ...
                                ListRutaSingleton.getInstance().onSort();
                            /*
